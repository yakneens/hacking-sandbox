...
class TestStrategy(bt.Strategy):
    params = (
        ('maperiod', 15),('printlog', True),('longmaperiod', 50)
    )
...
if __name__ == '__main__':
    ...
    datapath = os.path.join("","/Users/siakhnin/tools/quant/data/qqq_3_10_1999_9_5_2018.txt")
...
#     )
    ...
    # Add a strategy
    strats = cerebro.addstrategy(TestStrategy, maperiod=5)
