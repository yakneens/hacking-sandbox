...
class IBtick(tick):
    ...
    def resolve_tickids(self, tickid):
        return IBtick.tickid_dict.get(str(tickid), "ignorable_tick_id")
...
# ibcontract.symbol="SHOP"
# ibcontract.exchange="SMART"
# ibcontract.primaryExchange = "ISLAND"

# ibcontract = IBcontract()
# ibcontract.secType = "STK"
# ibcontract.symbol="QQQ"
# ibcontract.exchange="SMART"
# ibcontract.primaryExchange = "ISLAND"

# es = twsFutureOpt(symbol="ES", 
#                  exch="CME", 
#                  currency="USD", 
#                  conId = 317012336, 
#                  primary = "CME", 
