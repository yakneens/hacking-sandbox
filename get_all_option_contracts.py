...
symbol_list = ["SPY", "QQQ", "EEM", "IWM", "XLF", "GLD", "EFA", "VXX", "USO", "XOP", "FXI", "HYG", "AAPL", "BAC", "MU",
               ...
               "GOOG", "PFE", "ADBE", "ROKU", "RIG", "SLB", "QCOM", "HMNY", "MRK", "CLF", "V", "KO", "MA", "CVS", "DAL",
               ...
               "COP", "MTCH", "LB", "ADSK", "GPS", "TWX", "UAL", "VLO", "APA", "FIT", "LRCX", "STX", "AIG", "HPQ",
               ...
               "ANF", "BBT", "STZ", "CSX", "SVU", "AZN", "NOC", "SDRL", "SHAK", "CBS", "KORS", "MNST", "VMW", "HES",
...
def get_contracts(cur_symbol):
    general_contract = FuturesOption(symbol=cur_symbol, lastTradeDateOrContractMonth="", exchange="GLOBEX", multiplier="2500",
                              currency="USD")
...
def main():
    ...
    for symbol in symbol_list:
        ...
        result_df.to_sql("contracts", engine, if_exists="append")
